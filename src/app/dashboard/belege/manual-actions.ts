...
export async function computeBelegSumAction(formData: FormData): Promise<BelegSumResult> {
  ...
  const allowed: BelegSumKind[] = ["bgl", "mixvoip", "palettecad", "activite", "herosoftware", "circle", "etges", "niederer", "raabkarcher", "fliesenzentrum", "etbkenn", "kiesel", "moselbaustoff", "postdeep", "johanntrierweiler", "akemi", "maroldt", "hieronimi", "kennerbeton", "bureaucaisse", "sigre", "carlgeisen"];
